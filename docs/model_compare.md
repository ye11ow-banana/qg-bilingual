...
![passrate_bar.png](figures/passrate_bar.png)
- Pass-rate по експериментах виявляє стабільність генерації валідних питань.
![wh_heatmap.png](figures/wh_heatmap.png)
- Heatmap WH-типів показує баланс типів питань між моделями.
